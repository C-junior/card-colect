...
<div v-if="!isMobile()">
  <div class="nav-links">
    ...
    <router-link to="/rankingplayer">Item Shop</router-link> |
...
<div v-else>
  <div class="nav-links-mobile">
    ...
    <router-link to="/rankingplayer"><img src="./assets/backpack-icon.svg" alt=""></router-link>
...
.main-header {
  ...
  height: 80px;
  padding: 0 20px;
  box-shadow: 0 2px 4px rgba(211, 7, 7, 0.425);
}
...
width: 20%;
height: 80px;
border-bottom: 80px solid #860E0E;
...
width: 20.5%;
height: 80px;
border-bottom: 80px solid #e7e3e3;
border-left: 60px solid transparent; 
z-index: 0;
top: 0px;
right: 0px;
